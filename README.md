...
- `v0.3` - **DONE** - 56% of PhantomJS API ([v0.3 Release Notes](https://github.com/sdesalas/trifleJS/releases/tag/v0.3))
- `v0.4` - **DONE** - 72% of PhantomJS API ([v0.4 Release Notes](https://github.com/sdesalas/trifleJS/releases/tag/v0.4))
