...
%ILMerge% /out:%MergePath%\TrifleJS.exe %CompilePath%\TrifleJS.exe %CompilePath%\Microsoft.mshtml.dll %CompilePath%\Interop.IWshRuntimeLibrary.dll %CompilePath%\Interop.CERTENROLLLib.dll %CompilePath%\Newtonsoft.Json.dll
